...
sudo -u vagrant /bin/bash -c ". ~/.nvm/nvm.sh; nvm install --lts 6.9.1; nvm install 8.11.3; nvm install 11.11.0; nvm install 12.4.0; nvm install 12.6.0; nvm install 12.7.0"
